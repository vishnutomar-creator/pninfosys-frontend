...
export default function HeroSection() {
  const handleWhatsApp = () => {
    ...
    window.open(
      `https://wa.me/917000846823?text=${msg}`,
  ...
  return (
    <section className="relative overflow-hidden bg-white min-h-screen flex items-center pt-28 pb-20">
      {/* Background Blur */}
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tight text-slate-900">
              Learn.
              <br />
              <span className="text-[#009df2]">Build.</span>
              <br />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-10">
              <div>
                <h3 className="text-4xl font-black text-slate-900">5000+</h3>
                <p className="text-slate-500 font-medium">Students Trained</p>
              </div>

              <div>
                <h3 className="text-4xl font-black text-slate-900">500+</h3>
                <p className="text-slate-500 font-medium">Career Placements</p>
              </div>
          ...
          >
            ...
            >
              <h3 className="text-2xl font-black mb-2">Why PNINFOSYS?</h3>
